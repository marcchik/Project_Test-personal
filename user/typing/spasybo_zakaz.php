...
<head>
    ...
    <meta name="description" content="Спасибо за ваш заказ">
...
<div class="container-fluid" style="margin-bottom: 2rem;">
    <div class="row">
        <div class="col-12 text-center col_top_te">
            ...
            <h3 class=""><a href="/" target="_self">TestJobs.ru</a></h3>
...
<div class="container avtoForm" style="margin-bottom: 6rem;">
    <div class="row d-flex justify-content-center">
        <div class="col-12 col-lg-10 col-xl-7 text-center">
            ...
            <img src="/include/img/yago.jpg" style="width: 100%; max-width: 600px;">
            <h1>Спасибо за ваш заказ!</h1>
            <h2><a href='https://auth.robokassa.ru/Merchant/Index.aspx?MrchLogin=TestJobs&OutSum=2&InvId=2082&Desc=Оплата теста&SignatureValue=1675285bdcc5e593939f8ec511a9bad3'>Оплатить</a></h2>
