                                ...
                                <div class="card mb-5">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <form action="/user/staff/profile/typing/?id=<?=$_REQUEST['id']?>" method="post">
                                                    ...
                                                    <? if (isset($arrTyping)):?>
                                                        ...
                                                        <?foreach($arrTyping as $profession):?>
                                                            <?if ($profession == "Управляющий"):?>
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <label class="mb-3">Детские центры</label>
                                                                </div>
                                                                <div class="col-sm-6 col-xxl-3">
                                                                ...
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <div class="progress sh-2">
                                                                        <div class="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: <?=$PROPS['PROFESSION'][0][1];?>%;"><?=$PROPS['PROFESSION'][0][1];?>%</div>
                                                                        <?=$PROPS['PROFESSION'][0][1];?>%
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <? if ($PROPS['PROFESSION'][0][1] > 50):?>
                                                                        <label class="mb-3">Подходит</label>
                                                                    <? else:?>
                                                                        <label class="mb-3">Не подходит</label>
                                                                    <?endif;?>
                                                                </div>
                                                            <?endif;?>
                                                            <?if ($profession == "Администратор"):?>
                                                                ...
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <div class="progress sh-2">
                                                                        <div class="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: <?=$PROPS['PROFESSION'][1][1];?>%;"><?=$PROPS['PROFESSION'][1][1];?>%</div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <? if ($PROPS['PROFESSION'][1][1] > 50):?>
                                                                        <label class="mb-3">Подходит</label>
                                                                    <? else:?>
                                                                        <label class="mb-3">Не подходит</label>
                                                                    <?endif;?>
                                                            ...
                                                            <?if ($profession == "Педагог"):?>
                                                                ...
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <div class="progress sh-2">
                                                                        <div class="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: <?=$PROPS['PROFESSION'][2][1];?>%;"><?=$PROPS['PROFESSION'][2][1];?>%</div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <? if ($PROPS['PROFESSION'][2][1] > 50):?>
                                                                        <label class="mb-3">Подходит</label>
                                                                    <? else:?>
                                                                        <label class="mb-3">Не подходит</label>
                                                                    <?endif;?>
                                                            ...
                                                            <?if ($profession == "Няня"):?>
                                                                ...
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <div class="progress sh-2">
                                                                        <div class="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: <?=$PROPS['PROFESSION'][3][1];?>%;"><?=$PROPS['PROFESSION'][3][1];?>%</div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <? if ($PROPS['PROFESSION'][3][1] > 50):?>
                                                                        <label class="mb-3">Подходит</label>
                                                                    <? else:?>
                                                                        <label class="mb-3">Не подходит</label>
                                                                    <?endif;?>
                                                            ...
                                                            <?if ($profession == "Методист"):?>
                                                                ...
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <div class="progress sh-2">
                                                                        <div class="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: <?=$PROPS['PROFESSION'][4][1];?>%;"><?=$PROPS['PROFESSION'][4][1];?>%</div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <? if ($PROPS['PROFESSION'][4][1] > 50):?>
                                                                        <label class="mb-3">Подходит</label>
                                                                    <? else:?>
                                                                        <label class="mb-3">Не подходит</label>
                                                                    <?endif;?>
                                                            ...
                                                            <?if ($profession == "Продажник"):?>
                                                                ...
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <div class="progress sh-2">
                                                                        <div class="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: <?=$PROPS['PROFESSION'][5][1];?>%;"><?=$PROPS['PROFESSION'][5][1];?>%</div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <? if ($PROPS['PROFESSION'][5][1] > 50):?>
                                                                        <label class="mb-3">Подходит</label>
                                                                    <? else:?>
                                                                        <label class="mb-3">Не подходит</label>
                                                                    <?endif;?>
                                                            ...
                                                            <?if ($profession == "Художественный руководитель"):?>
                                                                ...
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <div class="progress sh-2">
                                                                        <div class="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: <?=$PROPS['PROFESSION'][6][1];?>%;"><?=$PROPS['PROFESSION'][6][1];?>%</div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <? if ($PROPS['PROFESSION'][6][1] > 50):?>
                                                                        <label class="mb-3">Подходит</label>
                                                                    <? else:?>
                                                                        <label class="mb-3">Не подходит</label>
                                                                    <?endif;?>
                                                            ...
                                                            <?if ($profession == "Психолог"):?>
                                                                ...
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <div class="progress sh-2">
                                                                        <div class="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: <?=$PROPS['PROFESSION'][7][1];?>%;"><?=$PROPS['PROFESSION'][7][1];?>%</div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <? if ($PROPS['PROFESSION'][7][1] > 50):?>
                                                                        <label class="mb-3">Подходит</label>
                                                                    <? else:?>
                                                                        <label class="mb-3">Не подходит</label>
                                                                    <?endif;?>
