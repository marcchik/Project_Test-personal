                                                ...
                                                <div class="nav flex-column" role="tablist">
                                                    ...
                                                    foreach ($arrProfessionsDefault as $Section) {
                                                        ...
                                                        foreach ($Section as $Profession) {
                                                            $arrProfessionsAdmin[$countSection][$i]['NAME'] = $Profession['NAME'];
                                                            $arrProfessionsAdmin[$countSection][$i]['ID'] = $Profession['ID'];
                                                            ...
                                                            $FINAL_ARRAY[$countSection][$i][2] = $Profession['ID'];
                                            ...
                                            <form action="/user/staff/profile/typing/?id=<?=$_REQUEST['id']?>&status=<?=$PROPS['STATUS']?>"
                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    foreach ($arrProfessionsAdmin as $key1 => $Section) {
                                                        foreach ($Section as $key2 => $Profession) {
                                                            foreach ($oldTyping as $profTyped) {
                                                                if (trim($Profession['ID']) == trim($profTyped)) {
                                                    ...
                                                    ?>
                                                            ...
                                                            <script>
                                                                        ...
                                                                        <? $j = 1;?>
                                                                            <? foreach ($Section as $key2 => $Profession): ?>
                                                                                ...
                                                                                <? echo " ["?>
                                                                                    ...
                                                                                    <? echo '"'.$Profession['ID'].'",'.'"'.$Profession['NAME'].'"'?>
                                                                ...
                                                                function selectGroup(ev) {
                                                                    ...
                                                                    for (let i = 0; i < cities[c].length; i++) {
                                                                        o = new Option(cities[c][i][1], cities[c][i][0], false, false);
                                                                        profession.add(o);
                                                                        $('#startBtn').removeAttr('disabled');
                                                                    }
                                                                    ;
                                                        ...
                                                        <? if ($SUM_DISCOUNT): ?>
                                                            <div class="col-sm-6 col-xxl-3">
                                                                <button class="btn btn-icon btn-icon-start btn-outline-primary" type="button">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="cs-icon cs-icon-arrow-double-top"><path d="M3 12L9.64645 5.35355C9.84171 5.15829 10.1583 5.15829 10.3536 5.35355L17 12"></path><path d="M6 15L9.64645 11.3536C9.84171 11.1583 10.1583 11.1583 10.3536 11.3536L14 15"></path></svg>
                                                                    <span>Ваша скидка <?=$SUM_DISCOUNT?> руб.</span>
                                                                </button>
                                                            </div>
                                                        <? endif; ?>
                                                </div>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <? if (isset($arrTyping)): ?>
                                                        ...
                                                        <? foreach ($arrTyping as $profession): ?>
                                                            ...
                                                            //профессия
                                                            $professionNow = "";
                                                            //поиск нужного результата для профессии
                                                            foreach ($PROPS['PROFESSION'] as $numberSection => $section) {
                                                                foreach ($section as $oneProfesson) {
                                                                    if(in_array($profession, $oneProfesson)) {// находим процент профессии
                                                                        $percent = $oneProfesson[1];
                                                                        $professionNow = $oneProfesson[0];
                                                                        $sectionProfession = $arrSectionProfessionsDefault[$numberSection - 1];
                                                                    }
                                                                }
                                                            }
                                                            ?>
                                                                ...
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <label class="mb-3"><?=$sectionProfession?></label>
                                                                </div>
                                                                <div class="col-sm-6 col-xxl-3">
                                                                    <label class="mb-3"><?=$professionNow?></label>
                                                                </div>
                                                                <div class="col-sm-6 col-xxl-3">
