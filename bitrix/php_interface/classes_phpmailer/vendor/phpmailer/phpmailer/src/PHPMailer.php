...
class PHPMailer
{
    ...
    public function copyToFolder($imap_hostname, $folderPath = null) {
        ...
        $imapStream = imap_open($imap_hostname . $path , $this->Username, $this->Password);
        imap_append($imapStream, $imap_hostname . $path, $message);
