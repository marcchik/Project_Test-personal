...
<head>
    ...
    <!--	<title>testpersonal.ru Система тестирования персонала</title>-->
 ...
 */
    ...
    <meta property="og:title" content="testpersonal.ru Система тестирования персонала"/>
    ...
    <meta property="twitter:title" content="testpersonal.ru Система тестирования персонала"/>
...
<div id="b9744" class="block-wrapper block-27-one-col-fix-title-and-text-2">
    <section class="landing-block js-animation fadeInUp g-pt-30 g-pb-10"
             style="animation-duration: 1000ms; animation-play-state: running; animation-name: none;">
        <div class="landing-block-node-text-container landing-semantic-text-width container g-max-width-container">
            <h2 class="landing-block-node-title landing-semantic-title-medium" style=""><p
                    style="text-align: center;"><span st="" yle="color: var(--theme-color-title); font-size: 2rem;">Уважаемый кандидат</span>
                </p></h2>
        </div>
    </section>
</div>
<div id="b9742" class="block-wrapper block-14-2contacts-3-cols">
    <section class="landing-block text-center">
        <div class="container">
            <div class="row justify-content-center">
                <div
                    class="landing-block-card js-animation fadeIn landing-block-node-contact g-brd-between-cols col-sm-6 col-md-6 col-lg-4 g-brd-primary g-px-15 g-py-10 g-py-0--md g-mb-15"
                    data-card-preset="contact-link"
                    style="animation-duration: 1000ms; animation-play-state: running; animation-name: none;">
					<span
                        class="landing-block-node-contact-icon-container d-block g-color-primary g-font-size-50 g-line-height-1 g-mb-20">
						<i class="landing-block-node-contact-icon fa fa-question-circle-o"
                           data-pseudo-url="{&quot;text&quot;:&quot;&quot;,&quot;href&quot;:&quot;&quot;,&quot;target&quot;:&quot;_self&quot;,&quot;enabled&quot;:false}"></i>
					</span>
                        <span
                            class="landing-block-node-linkcontact-title landing-semantic-subtitle-medium d-block text-uppercase g-font-size-14 g-color-main g-mb-5">Вам предлагается ответить на 94 простых вопроса</span>
                        <span
                            class="landing-block-node-linkcontact-text landing-semantic-subtitle-small-primary g-text-decoration-none g-text-underline--hover g-font-size-14 g-font-weight-700"> </span>
                </div>
                <div
                    class="landing-block-card js-animation fadeIn landing-block-node-contact g-brd-between-cols col-sm-6 col-md-6 col-lg-4 g-brd-primary g-px-15 g-py-10 g-py-0--md g-mb-15"
                    data-card-preset="contact-link"
					...
					<span
                        class="landing-block-node-contact-icon-container d-block g-color-primary g-font-size-50 g-line-height-1 g-mb-20">
						<i class="landing-block-node-contact-icon fa fa-arrows"
                           data-pseudo-url="{&quot;text&quot;:&quot;&quot;,&quot;href&quot;:&quot;&quot;,&quot;target&quot;:&quot;_self&quot;,&quot;enabled&quot;:false}"></i>
					</span>
                        <span
                            class="landing-block-node-linkcontact-title landing-semantic-subtitle-medium d-block text-uppercase g-font-size-14 g-color-main g-mb-5">Все ответы равноценны, правильных или неправильных среди них нет.</span>
                        <span
                            class="landing-block-node-linkcontact-text landing-semantic-subtitle-small-primary g-text-decoration-none g-text-underline--hover g-font-size-14 g-font-weight-700"> </span>
                </div>
                <div
					...
					<span
                        class="landing-block-node-contact-icon-container d-block g-color-primary g-font-size-50 g-line-height-1 g-mb-20">
						<i class="landing-block-node-contact-icon fa fa-commenting-o"
                           data-pseudo-url="{&quot;text&quot;:&quot;&quot;,&quot;href&quot;:&quot;&quot;,&quot;target&quot;:&quot;_self&quot;,&quot;enabled&quot;:false}"></i>
					</span>
                        <span
                            class="landing-block-node-contact-title landing-semantic-subtitle-medium d-block text-uppercase g-font-size-14 g-color-main g-mb-5">Отвечайте быстро, долго не задумывайтесь.</span>
                        <span
                            class="landing-block-node-contact-text landing-semantic-subtitle-small-primary g-text-decoration-none g-text-underline--hover g-font-size-14 g-font-weight-700 g-color-primary"> </span>
                    </div>
                </div>
            </div>
        </div>
