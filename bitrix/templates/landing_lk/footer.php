                ...
                <div class="col-12 col-sm-6">
                    ...
                    <p class="mb-0 text-muted text-medium">
                        <span class="bitrix-footer-text">
                            © 2021 <a style="color: gray; text-decoration: none" href="https://testpersonal.ru/">TestPersonal.ru</a> - All rights reserved.
                        </span>
                    </p>
                </div>
            </div>
...
<script src="/bitrix/templates/landing_lk/js/vendor/jquery-3.5.1.min.js"></script>
<script src="/bitrix/templates/landing_lk/js/vendor/bootstrap.bundle.min.js"></script>
<script src="/bitrix/templates/landing_lk/js/vendor/OverlayScrollbars.min.js"></script>
<script src="/bitrix/templates/landing_lk/js/vendor/autoComplete.min.js"></script>
<script src="/bitrix/templates/landing_lk/js/vendor/clamp.min.js"></script>
<script src="/bitrix/templates/landing_lk/js/vendor/select2.full.min.js"></script>
<script src="/bitrix/templates/landing_lk/js/vendor/singleimageupload.js"></script>
<script src="/bitrix/templates/landing_lk/js/vendor/list.js"></script>
<!-- Vendor Scripts End -->

<!-- Template Base Scripts Start -->
<script src="font/CS-Line/csicons.min.js"></script>
<script src="/bitrix/templates/landing_lk/js/base/helpers.js"></script>
<script src="/bitrix/templates/landing_lk/js/base/globals.js"></script>
<script src="/bitrix/templates/landing_lk/js/base/nav.js"></script>
<script src="/bitrix/templates/landing_lk/js/base/search.js"></script>
<script src="/bitrix/templates/landing_lk/js/base/settings.js"></script>
<script src="/bitrix/templates/landing_lk/js/base/init.js"></script>
<!-- Template Base Scripts End -->
<!-- Page Specific Scripts Start -->
<script src="/bitrix/templates/landing_lk/js/cs/checkall.js"></script>
<script src="/bitrix/templates/landing_lk/js/apps/contacts.js"></script>
<script src="/bitrix/templates/landing_lk/js/common.js"></script>
<script src="/bitrix/templates/landing_lk/js/scripts.js"></script>
