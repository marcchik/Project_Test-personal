...
<!--                                    <textarea cols="--><?//=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?><!--" rows="--><?//=$arResult["PROPERTY_LIST_FULL"][$propertyID]["ROW_COUNT"]?><!--" name="PROPERTY[--><?//=$propertyID?><!--][--><?//=$i?><!--]">--><?//=$value?><!--</textarea>-->
                                    ...
                                    <?if($propertyID == 'PREVIEW_TEXT'):?>
                                        ...
                                        <textarea style="display: none" cols="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>" rows="1" name="PROPERTY[<?=$propertyID?>][<?=$i?>]"><?=$arResult['ELEMENT']['PREVIEW_TEXT']?></textarea>
                            ...
                            case "N":
                                for ($i = 0; $i<$inputNum; $i++)
                                {
                                    ...
                                    <?pr($propertyID);?>
                                        <?if($propertyID == "NAME"):?>
                                            <?$arResult['ELEMENT']['NAME'] = 'Пополнение баланса - 9';?>
                                            <textarea  cols="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>" rows="1" name="PROPERTY[<?=$propertyID?>][<?=$i?>]"><?=$arResult['ELEMENT']['NAME']?></textarea>
        ...
        <tr>
            <td colspan="2">
                ...
                <input name="balance" class="form-control" placeholder="Введите баланс">
