        ...
        <div class="row g-0">
            ...
            <div class="col-12 col-sm-6 col-md d-flex align-items-start justify-content-end order-3 order-sm-2">
                <div class="w-100 w-lg-auto search-input-container border border-separator">
                    <input id="search" class="form-control search filter-search" type="text" autocomplete="off" placeholder="Поиск кандидата">
            ...
            <div
                ...
                <button type="button"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"
                         ...
                         class="cs-icon cs-icon-plus">
                        <path d="M10 17 10 3M3 10 17 10"></path>
                    </svg>
                    <span>Пригласить кандидата</span>
                </button>
                <div class="dropdown d-inline-block d-lg-none">
                    <button type="button" class="btn btn-outline-primary btn-icon btn-icon-only ms-1"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                             ...
                             stroke-linejoin="round" class="cs-icon cs-icon-sort">
                            <path d="M6 18 6 3M14 2 14 17"></path>
                            <path d="M3 5 6 2 9 5M11 15 14 18 17 15"></path>
                        </svg>
                    </button>
        ...
        <div class="col-12 col-xl-12 col-xxl-12">
            ...
            <ul class="nav nav-tabs nav-tabs-title nav-tabs-line-title responsive-tabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link" data-bs-toggle="tab" href="#testTab" onclick="testTab();" role="tab" aria-selected="true">Прошли тест</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" data-bs-toggle="tab" href="#allTab" onclick="allTab();" role="tab" aria-selected="false">Все кандидаты</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" data-bs-toggle="tab" href="#" onclick="typingTab();" role="tab" aria-selected="false">Типирован</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" data-bs-toggle="tab" href="#" onclick="inviteTab();" role="tab" aria-selected="false">Приглашены</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" data-bs-toggle="tab" href="#" onclick="arhiveTab();" role="tab" aria-selected="false">Архив</a>
                </li>
            ...
            <div class="tab-content">
                <!-- Friends Tab Start -->
                <div class="tab-pane fade show" id="testTab" role="tabpanel">
                ...
                <!-- Friends Tab Start -->
                <div class="tab-pane fade active" id="allTab" role="tabpanel">
                    <div class="row g-0">
                        <div class="col">
                            <!-- List Items Start -->
                                            ...
                                            <div class="ps-0 ps-5 pe-4 pt-0 pb-0 h-100">
                                                <div class="row g-0 h-100 align-content-center custom-sort">
                                                    <div class="col-3 col-lg-4 d-flex flex-column mb-lg-0 pe-3 d-flex">
                                                        <div class="text-muted text-small cursor-pointer sort" data-sort="name">ФИ</div>
                                                    </div>
                                                    ...
                                                    <div class="col-3 col-lg-3 d-flex flex-column pe-1 justify-content-center">
                                                        <div class="text-muted text-small cursor-pointer sort" data-sort="phone">Статус</div>
                                                    </div>


                                                    <div class="col-3 col-lg-2 d-flex flex-column pe-1 justify-content-center">
                                                        <div class="text-muted text-small cursor-pointer sort" data-sort="group">Настройки</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mb-2">
                                                ...
                                                <div class="row g-0 h-100 sh-lg-9 position-relative">
                                                    <a href="/user/staff/profile/?id=<?=$arElement["ID"]?>" class="col-auto position-relative ">
                                                        <img src="/bitrix/templates/.default/components/bitrix/iblock.element.add/staff/bitrix/iblock.element.add.list/.default/user.png" alt="user" class="card-img card-img-horizontal sw-11 h-100 h-100 sh-lg-9 thumb" id="contactThumb">
                                                    </a>
                                                                ...
                                                                <div class="col-12 col-lg-1 d-flex flex-column pe-1 mb-2 mb-lg-0 align-items-start justify-content-center order-5">
                                                                    <?if ($arElement["CAN_DELETE"] == "Y"):?>
                                                                        <div class="form-group mx-sm-1 ">
                                                                            <form  class="form-inline" action="/user/staff/?id=<?=$arElement["ID"]?>&name=<?=$name_surname?>" method="post">
                                                                                <input type="submit" value="Добавить в архив" name="addArhive" class="btn btn-danger"/>
                                                                            </form>
                                                                        </div>
                                ...
                                <div class="w-100 d-flex justify-content-center">
                                    <div class="pagination">
                                        <li class="page-item prev disabled">
                                            <a class=" page-link " href="javascript:function Z(){Z=&quot;&quot;}Z()">
                                                <i
                                                    class="cs-chevron-left">
                                                </i>
                                            </a>
                                        </li>
                                        <li class="page-item active">
                                            <a class=" page-link shadow" href="javascript:function Z(){Z=&quot;&quot;}Z()">
                                                1
                                            </a>
                                        </li>
                                        <li class="page-item">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer border-0">
                                        ...
                                        if( isset( $_POST['addArhive'] ) )
                                        {
                                            ...
                                            $PRODUCT_ID = $_REQUEST['id'];  // изменяем элемент с кодом (ID)
                                            $res = $el->Update($PRODUCT_ID, $arLoadProductArray);

                                            //переадресация на страницу после вывода сообщения
                                            echo "<script>alert('Сотрудник добавлен в архив!');
                ...
                <!-- Projects Tab Start -->
                <div class="tab-pane fade active" id="typingTab" role="tabpanel">
                    <div class="row g-0">
                        <div class="col">
                            <!-- List Items Start -->
                            <div id="checkboxTable">
                ...
                <div class="tab-pane fade" id="typingTab" role="tabpanel">
