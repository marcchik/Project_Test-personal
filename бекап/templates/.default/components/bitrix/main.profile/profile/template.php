...
<?if($arResult["PHONE_REGISTRATION"]):?>
	<tr>
		...
		<td>
            <div class="form-group form-group2">
                <input type="text" class="form-control" name="PHONE_NUMBER" maxlength="50" value="<? echo $arResult["arUser"]["PHONE_NUMBER"]?>" />
            </div>
        </td>
	</tr>
<?endif?>
...
<table class="data-table profile-table">
	...
	<p><input type="submit" name="save" class="btn btn-success" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;<input type="reset" class="btn btn-danger" value="<?=GetMessage('MAIN_RESET');?>"></p>
</form>
