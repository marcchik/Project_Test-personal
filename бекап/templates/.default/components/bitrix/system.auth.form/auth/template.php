...
<?endif?>
		<tr>
			<td colspan="2"><input class="btn btn-success"  type="submit" name="Login" value="<?=GetMessage("AUTH_LOGIN_BUTTON")?>" /></td>
		</tr>
...
<!--			<td colspan="2">-->
<!--                <noindex>-->
<!--                    <a href="--><?//=$arResult["AUTH_FORGOT_PASSWORD_URL"]?><!--" class="btn btn-secondary" rel="nofollow">-->
