...
<!--style="height: 100vh"-->
    <div class="row avtoForm_row row_nachal" >
        ...
        <br>
        <div class="b24-form-control-container text-center ">
    ...
    <div class="form-row"  style="margin-bottom: 1rem;">
        <div class="col-12">
            <div class="input-group">
                ...
                <input class="form-control"  data-name="E-mail"  name="email" id="email" type="email" maxlength="25" value="" placeholder="Ваш E-mail" aria-describedby="telPrepend" required="required">
            </div>
        </div>
    </div>
