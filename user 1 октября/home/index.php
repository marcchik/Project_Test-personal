                        ...
                        <form class="form-inline" >
                            <div class="form-group mb-2 mt-2">
                                ...
                                <div class="mb-3 filled w-100 d-flex flex-column">
                                    ...
                                    <input class="form-control" readonly="readonly" type="text" value="https://testpersonal.ru/ts/?id=<?=base64_encode("user".$USER->GetID());?>" id="myInput">
                                </div>
                                <!-- The button used to copy the text -->
                            </div>
                            <button class="btn btn-primary ml-2 mb-2"style="width: 200px;" onclick="myFunction()">Скопировать ссылку</button>
                    ...
                    <div class="card-body text-center align-items-center d-flex flex-column justify-content-between">
                        <form class="form-inline" action="/user/home/" method="post">
                            <div class="form-group mb-2 mt-2">
                                ...
                                <div class="mb-3 filled w-100 d-flex flex-column">
                                    <input name="email"  class="form-control" placeholder="Получите скидку" id="contactEmailModal">
                                </div>
                                <!-- The button used to copy the text -->
                            </div>
                            <input id="promoBtn" disabled="disabled" type="submit" value="Активировать промокод" name="invite" class="btn btn-primary ml-2 mb-2"/>
...
<!--                                <img src="/bitrix/templates/landing_lk/3F3D.gif" alt="Пример" class="mb-2" width="100%" height="100%">-->
    ...
    $message = 'Вас приглашают пройти тест по типированию сотрудников - https://testpersonal.ru/ts/?staff='.base64_encode("staff".$STAFF_ID);
    # Если кнопка нажата
